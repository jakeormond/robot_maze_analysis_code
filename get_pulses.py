...
def load_imec_pulses(): # these are the pulses generated by extract_pulses_from_raw.py
...
def load_bonsai_pulses(directory): # this the h5 file generated by get_bonsai_pulses
    # use tkinter to select the file
    root = tk.Tk()
    root.withdraw()
